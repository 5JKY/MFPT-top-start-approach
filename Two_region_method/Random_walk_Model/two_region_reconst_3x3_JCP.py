...
fig.savefig("two_Pst.pdf", bbox_inches="tight")
plt.close(fig)
...
fig.savefig("two_MFPT.pdf", bbox_inches="tight")
plt.close(fig)
...
fig.savefig("two_reconst.pdf", bbox_inches="tight")
plt.close(fig)

print("Generated: two_Pst.pdf, two_MFPT.pdf, two_reconst.pdf")
