...
plt.plot(n1_arr, top_Pst_n1, '--', label="RW A", color='red', marker='o', markevery=15)
# plt.plot(n1_arr, two_Pst_n1, label="walkers left (two)")
plt.plot(n2_arr, top_Pst_n2, '--', label="RW B", color='blue', marker='o', markevery=15)
# plt.plot(n2_arr, two_Pst_n2, label="walkers right (two)")
plt.xticks(fontsize=14, fontweight='bold')
plt.yticks(fontsize=14, fontweight='bold')
...
plt.savefig("top_Pst.png", dpi=600, bbox_inches='tight')  # high-quality PNG
plt.show()
...
plt.plot(n1_arr, -np.log(top_Pst_n1), '--', label="RW A", color='red', marker='o', markevery=15)
# plt.plot(n1_arr, -np.log(two_Pst_n1), label="walkers left (two)")
plt.plot(n2_arr, -np.log(top_Pst_n2), '--', label="RW B", color='blue', marker='o', markevery=15)
# plt.plot(n2_arr, -np.log(two_Pst_n2), label="walkers right (two)")
plt.xticks(fontsize=14, fontweight='bold')
plt.yticks(fontsize=14, fontweight='bold')
plt.xlabel(r'$x$', fontsize=20, fontweight='bold')
...
for text in legend.get_texts():
    text.set_fontweight('bold')
    text.set_color('black')
plt.savefig("top_lnPst.png", dpi=600, bbox_inches='tight')  # high-quality PNG
plt.show()
...
plt.plot(n1_arr, top_mfpt_n1, '--', label="RW A", color='red', marker='o', markevery=15)
# plt.plot(n1_arr, two_mfpt_n1, label="walkers left (two)")
plt.plot(n2_arr, top_mfpt_n2, '--', label="RW B", color='blue', marker='o', markevery=15)
# plt.plot(n2_arr, two_mfpt_n2, label="walkers right (two)")
plt.xlabel(r'$x$', fontsize=20, fontweight='bold')
...
for text in legend.get_texts():
    text.set_fontweight('bold')
    text.set_color('black')
plt.savefig("top_MFPT.png", dpi=600, bbox_inches='tight')  # high-quality PNG
plt.show()
...
# plt.plot(x1_arr[1:-1], trans_reconst_n1, '--', label="matrix reconst left")
# plt.plot(x2_arr[1:-1], trans_reconst_n2, '--', label="matrix reconst right")
...
plt.plot(n1_arr[1:-1], top_reconst_n1, '--', label="RW A", color='red', marker='o', markevery=15)
# plt.plot(n1_arr[1:-1], two_reconst_n1, label="walkers left (two)")
plt.plot(n2_arr[1:-1], top_reconst_n2, '--', label="RW B", color='blue', marker='o', markevery=15)
...
plt.xticks(fontsize=14, fontweight='bold')
plt.yticks(fontsize=14, fontweight='bold')
# plt.title('Top-Start Free Energy Reconstruction', fontsize=16, fontweight='bold')
# plt.legend(fontsize=12)
# Add legend here (after plotting, before saving/showing)
legend = plt.legend(fontsize=13, loc='best', frameon=True)
# Optional: Bold legend text and thicken frame
for text in legend.get_texts():
    text.set_fontweight('bold')
    text.set_color('black')
plt.savefig("top_reconst.png", dpi=600, bbox_inches='tight')  # high-quality PNG
plt.show()
