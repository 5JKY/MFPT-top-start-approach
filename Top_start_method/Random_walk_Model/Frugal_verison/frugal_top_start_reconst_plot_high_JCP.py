...
ax.plot(x1_arr, ari1_trans.steady_state,
        label="TM A", color="darkgreen")
ax.plot(x2_arr, ira2_trans.steady_state,
        label="TM B", color="darkorange")

ax.plot(n1_arr, top_Pst_n1, "--",
        label="RW A", color="red",
        marker="o", markersize=3.2, markevery=15)
ax.plot(n2_arr, top_Pst_n2, "--",
        label="RW B", color="blue",
        marker="o", markersize=3.2, markevery=15)
...
ax.plot(x1_arr, trans_mfpt_n1,
        label="TM A", color="darkgreen")
ax.plot(x2_arr, trans_mfpt_n2,
        label="TM B", color="darkorange")

ax.plot(n1_arr, top_mfpt_n1, "--",
        label="RW A", color="red",
        marker="o", markersize=3.2, markevery=15)
ax.plot(n2_arr, top_mfpt_n2, "--",
        label="RW B", color="blue",
        marker="o", markersize=3.2, markevery=15)
...
ax.plot(x_full, beta_U(x_full),
        label="Original", color="black", linewidth=2.0)

ax.plot(n1_arr[1:-1], top_reconst_n1, "--",
        label="RW A", color="red",
        marker="o", markersize=3.2, markevery=15)
ax.plot(n2_arr[1:-1], top_reconst_n2, "--",
        label="RW B", color="blue",
        marker="o", markersize=3.2, markevery=15)
