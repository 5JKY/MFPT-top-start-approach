...
fig.savefig("top_Pst.eps", format="eps", bbox_inches="tight")
plt.close(fig)
...
fig.savefig("top_MFPT.eps", format="eps", bbox_inches="tight")
plt.close(fig)
...
# ============================================================
# (c) Top-Start free-energy reconstruction
# ============================================================
fig, ax = plt.subplots(figsize=(3.3, 2.75), constrained_layout=True)
...
# Top-Start reconstruction from RW trajectories
ax.plot(
    n1_arr[1:-1],
    top_reconst_n1,
    label="RW A",
...
fig.savefig("top_reconst.eps", format="eps", bbox_inches="tight")
plt.close(fig)

print("Generated: top_Pst.eps, top_MFPT.eps, top_reconst.eps")
